...
```{r,cache=TRUE,fig.height=10, ref.label="chunk1"}
getimage(2)
```
...
По результатам анализа видно, что первая компонента сильно коррелирует с переменной Х13, пятая --- с Х6 и Х15, третья --- с Х11 и Х9, вторая --- с Х11, четвёртая --- с Х5, шестая --- с Х7.
