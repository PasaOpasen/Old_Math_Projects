...
install.packages(c("readxl","dplyr","ggplot2","ggpubr","corrplot",
                  "psych","MASS","tree","randomForest","TeachingDemos","mice","corrgram"))
```
и подключаются
```{r}
library(readxl)
...
geom_line(aes(y=Distrinct3),size=1,col=5)
g5=  ggplot(means,aes(x=Year))+
geom_line(aes(y=Distrinct4),size=1,col=6)
g6= ggplot(means,aes(x=Year))+
geom_line(aes(y=Distrinct5),size=1,col=7)
g7= ggplot(means,aes(x=Year))+
geom_line(aes(y=Distrinct6),size=1,col=8)
g8=  ggplot(means,aes(x=Year))+
geom_line(aes(y=Distrinct7),size=1,col=9)
g9=  ggplot(means,aes(x=Year))+
geom_line(aes(y=Distrinct8),size=1,col=10)
g10=  ggplot(means,aes(x=Year))+
  geom_line(aes(y=Distrinct9),size=1,col=11)
library(ggpubr)
