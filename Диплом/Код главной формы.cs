...
namespace Курсач
{
    public partial class MyForm : Form
    {
        ...
        public MyForm()
        {
            ...
            try
            {
            StreamReader s = new StreamReader("Directname.txt");
            DirectName = s.ReadLine()+"\\";
            s.Close();
            }
            catch { DirectName = ""; }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            KursMethods.MIN_RADIUS = Convert.ToDouble(textBox8.Text);
            KursMethods.MAX_RADIUS = Convert.ToDouble(textBox9.Text);
            KursMethods.LMIN_RADIUS = Convert.ToDouble(textBox11.Text);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                DirectName = folderBrowserDialog1.SelectedPath;
                StreamWriter s = new StreamWriter("Directname.txt");s.WriteLine(DirectName);
                s.Close();
            }
        }
    }
